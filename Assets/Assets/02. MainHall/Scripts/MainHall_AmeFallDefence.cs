...
public class MainHall_AmeFallDefence : MonoBehaviour
{
    ...
    // private MainHall_StartStoryAndTutorial mainHall_StartStoryAndTutorial;
    ...
    //    mainHall_StartStoryAndTutorial = GameObject.FindAnyObjectByType<MainHall_StartStoryAndTutorial>();
    //}
    ...
    //    {
    //        collision.transform.position = sponPos.position;    // 강제 이동
    //    }
    //}
    ...
    //    {
    //        other.transform.position = sponPos.position;    // 강제 이동
    //    }
    //}
    ...
    //    if (other.gameObject.GetComponent<PlayerCtrl>() != null)
    //    {
    //        if (mainHall_StartStoryAndTutorial.isStoryEnd)
    //        {
    //            other.transform.position = sponPos.position;    // 강제 이동
    //        }
    //    }
